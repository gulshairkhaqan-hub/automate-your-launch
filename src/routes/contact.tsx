          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-3 space-y-6">
              <GlowCard gradient={getGradient(0)} delay={0.1}>
                <div className="p-7 md:p-9">
                  <h3 className="font-heading text-xl font-bold text-white mb-1">Tell us about your business</h3>
                  <p className="text-sm text-gray-400 mb-6">We'll respond within 24 hours with a personalized automation assessment.</p>
                  <LeadCaptureForm />
                </div>
              </GlowCard>
              ...
              <GlowCard gradient={getGradient(1)} delay={0.2}>
                <div className="p-7 md:p-9">
                  <h3 className="font-heading text-xl font-bold text-white mb-1">Prefer to book directly?</h3>
                  <p className="text-sm text-gray-400 mb-6">Skip the form and schedule a 30-min strategy call at a time that works for you.</p>
                  <div className="rounded-xl bg-[#1A1A1C] border border-dashed border-white/10 p-10 text-center">
                    <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-[#1A1A1C] border border-white/10 mb-4">
                      <svg className="w-7 h-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" />
                      </svg>
                    </div>
                    <p className="font-heading text-lg font-bold text-white">Calendar Scheduling</p>
                    <p className="font-mono text-xs text-[#7DD3FC] mt-1">// calendly_integration: pending</p>
                    <p className="text-xs text-gray-500 mt-2">In the meantime, fill out the form above and we'll schedule you within 24 hours.</p>
                  </div>
                </div>
              </GlowCard>
            </div>
            ...
            <div className="lg:col-span-2 space-y-5">
              <GlowCard gradient={getGradient(2)} delay={0.1}>
                <div className="p-7">
                  <h4 className="font-heading text-lg font-bold text-white mb-4">What you'll get</h4>
              ...
              <GlowCard gradient={getGradient(3)} delay={0.2}>
                <div className="p-7">
                  <h4 className="font-heading text-lg font-bold text-white mb-2">Chat on WhatsApp</h4>
                  <p className="text-sm text-gray-400 mb-4">Quick question? Reach us directly.</p>
                  <WhatsAppLink
              ...
              <GlowCard gradient={getGradient(4)} delay={0.3} borderWidth={1} glowBlur={30} glowOpacity={0.4}>
                <div className="p-7">
                  <span className="text-2xl">🛡️</span>
                  <h4 className="font-heading text-lg font-bold text-white mt-3">Our guarantee</h4>
              ...
              <GlowCard gradient={getGradient(5)} delay={0.4} borderWidth={1} glowBlur={25} glowOpacity={0.35}>
                <div className="p-7">
                  ...
                  <div className="space-y-2.5 text-sm text-gray-400 font-mono">
                    <p className="flex items-center gap-2">
                      ...
                      <MailtoLink subject="Inquiry from automation.studio" className="hover:text-white transition-colors">
                        {OWNER_EMAIL}
                      </MailtoLink>
                    </p>
                    <p className="flex items-center gap-2">
                    ...
                    <p className="flex items-center gap-2"><span className="text-[#7DD3FC]">→</span> Mon–Fri, 9am–6pm PKT</p>
                  </div>
                </div>
              </GlowCard>
            </div>
